  ...
  val radio = name / (2 * pi)
  println("El radio del circulo con circunferencia de " + name + " Es de: " 
  + radio)
  ...
  // 3. Dada la variable bird = "tweet", utiliza interpolación 
  // de string para imprimir  "Estoy escribiendo un tweet"
  val tweet = "tweet"
  println(s"Estoy escribiendo un $tweet")
  
  // 4. Dada la variable mensaje = "Hola luke yo soy tu padre!" 
  // utilza slilce para extraer
  // la secuencia "Luke"
